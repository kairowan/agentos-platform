...
grep -q 'thought_field_surface_vertex.glsl' "${project_root}/scripts/thought-field-preview.html"
grep -q 'createSurface(rings = 64, segments = 28)' "${project_root}/scripts/thought-field-preview.html"
